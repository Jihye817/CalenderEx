...
public class PlaysPopupActivityS extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plays_popup_s);
        ...
        btnBuy.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                buyResult=dbHelper.buyPlay(2);
                if(buyResult.equals(buy)) {// 구매 성공
                    Toast.makeText(PlaysPopupActivityS.this, "구매 성공!", Toast.LENGTH_SHORT).show();
                }
                else if(buyResult.equals(already)) { // 이미 존재하는 장난감
                    Toast.makeText(PlaysPopupActivityS.this, "이미 가지고 있는 장난감이네요!", Toast.LENGTH_SHORT).show();
                }
                else { // 구매 실패
                    Toast.makeText(PlaysPopupActivityS.this, "포인트가 모자라요ㅜㅜ.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
